...
.. glossary::
   ...
   CPython
     ...
     the Python programming language. It is written in C and is typically
   ...
   FORTRAN
     A computer programming language used to play Star Trek games in the 1970s. It
     has survived death-blows from Python over the years.
   ...
   IDE
     ...
     programmers for software development. The most popular one right now is
   ...
   pydice
     A Python module available from this `GitHub <https://github.com/ShawnDriscoll/pydice/>`__ repository.

   PyQt
     The best GUI for Python. It is the Python version of Qt, which is the C version of the GUI.

   Python 3.9
     A version of Python, used the-world-over, to write pydice in. As of this writing, Python
     is the most popular computer programming language of all time.
